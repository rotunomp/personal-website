            ...
            <div className="About p-0 m-0">
                ...
                <div className={'row'}>
                    <div className={'col-12 col-lg-4 mx-2 mx-lg-0 ml-lg-4 pl-lg-4 h1'}>
                        ...
                        <hr></hr>
                        <p className={'mr-3'}>
                        Hi, my name is Michael Rotuno. I'm a Software Engineer taking my first steps in the industry. I graduated from Miami University (Ohio) in 2019, and since then I've done projects exploring many routes in the world of programming. My favorite one so far is Botify, a service which notifys users about music releases. Working on these projects has solidified what I want in my career: <strong>variety, strong collaboration with coworkers, and endless learning.</strong>
                        </p>
